...
func (ctl *accessController) newToken(secret []byte) (string, error) {
...
func (ctl *accessController) initByToken(token string, secret []byte) error {
...
func (ctl *accessController) refreshToken(expiry int64, secret []byte) (string, error) {
