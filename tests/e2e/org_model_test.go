...
// 拥有read权限的用户可以创建和删除模型
func (s *SuiteOrgModel) TestOrgReadMemberCantCreateModel() {
...
func (s *SuiteOrgModel) TestOrgWriteCreateModel() {
...
// 拥有write权限的用户可以删除他人的模型
func (s *SuiteOrgModel) TestOrgWriteCreateOthersModel() {
...
// 拥有contribute权限的用户可以创建和删除模型
func (s *SuiteOrgModel) TestOrgContributorCreate() {
	_, r, err := Api.OrganizationApi.V1OrganizationNameMemberPut(Auth, swagger.ControllerOrgMemberEditRequest{
		User: "test2",
		Role: "contributor",
	}, s.name)
...
func (s *SuiteOrgModel) TestOrgContributorCantDeleteOthersModel() {
	_, r, err := Api.OrganizationApi.V1OrganizationNameMemberPut(Auth, swagger.ControllerOrgMemberEditRequest{
		User: "test2",
		Role: "contributor",
	}, s.name)
