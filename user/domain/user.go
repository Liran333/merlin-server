...
func (cmd TokenCreatedCmd) Validate() error {
	if cmd.Name == nil {
		...
		return allerror.New(allerror.ErrorMissingNameWhenCreatingToken, "", e)
	}

	if cmd.Account == nil {
		e := fmt.Errorf("missing account when creating token")
		return allerror.New(allerror.ErrorMissingAccountWhenCreatingToken, "", e)
	}
...
func (cmd TokenDeletedCmd) Validate() error {
	if cmd.Account == nil {
		...
		return allerror.New(allerror.ErrorMissingAccountWhenDeleteToken, "", e)
	}

	if cmd.Name == nil {
		e := fmt.Errorf("missing name when delete token")
		return allerror.New(allerror.ErrorMissingNameWhenDeleteToken, "", e)
	}
